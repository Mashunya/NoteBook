...
public class ParamDescription {
    ...
    public class Builder {
        ...
        public ParamDescription build() throws ExpectedDefaultValueException {
            if(ParamDescription.this.required == false && ParamDescription.this.defaultValue == null) {
                throw new ExpectedDefaultValueException(ParamDescription.this.paramName);
            }
